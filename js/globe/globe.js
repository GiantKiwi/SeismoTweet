...
DAT.Globe = function(container, colorFn) {
  ...
  colorFn = colorFn || function(x) {
  	var tmpColor='0x000000';
  	
  	//en base escala richter o mw
  	if (x >=4 && x <5) tmpColor='0x66CC00';
  	if (x >=5 && x <6) tmpColor='0xFFFF00';
  	if (x >=6 && x <7) tmpColor='0xFF6600';
  	if (x >=7 && x <8) tmpColor='0xFF3300';
  	if (x >=8 && x <9) tmpColor='0xFF0000';
  	if (x >=9) tmpColor='0x330033';
    var c = new THREE.Color(tmpColor);
  
    //c.setHSV( ( 0.6 - ( x * 0.08 ) ), 1.0, 1 );
    return c;
  };
  ...
  function init() {
    ...
    geometry = new THREE.Cylinder(1, 1, 1, 1);
    var geometry2 = new THREE.Cylinder( 20, 1, 1, 1 );
  ...
  function addPoint(lat, lng, size, color, subgeo) {
    ...
    point.scale.x = size*.07;
    point.scale.y = size*.07;
    point.updateMatrix();
